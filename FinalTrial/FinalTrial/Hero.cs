...
namespace FinalTrial
{
    class Hero
    {
        ...
        public Hero(bool antihero, string gender)
        {
            this.Antihero=antihero; 
            this.Gender=gender;
        }
        ...
        {
            Console.WriteLine(this.Name + " is Crafting with " + material);
        }
...

        {
            ...
            while (PowerLevel < 50)
            {
                Console.WriteLine(this.Name + " has a power of " + this.PowerLevel);
